...
wget http://ftp.us.debian.org/debian/pool/main/libs/libseccomp/libseccomp-dev_2.5.4-1_armhf.deb || error "Failed to download libseccomp2.deb"
sudo dpkg -i libseccomp-dev_2.5.4-1_armhf.deb || error "Failed to install libseccomp2.deb"
